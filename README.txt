...
a persistence unit "SistemaBancario1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SistemaBancario1\pom.xml":
...
artifact ("SistemaBancario1.war") is already built. You can build
